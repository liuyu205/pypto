...
# Kernel: load two tiles, add them, apply relu, and cast result
@fe.kernel
def add_relu_cast_kernel(
    ...
    with pl.section_vector():
        ...
        plm.add_relu_cast(tile_c, tile_a, tile_b, target_type=pl.FP32, mode="round")
...
def test_add_relu_cast():
    ...
    compiled_lib = fe.compile(add_relu_cast_kernel, arch="dav-c220-vec")
    ...
    print(z)
    z_add = x + y
    z_relu = torch.relu(z_add).to(dtype_out)
    print("***********golden output***********")
