...
# C CANN Open Software License Agreement Version 2.0 (the "License").
...
# Kernel: load two tiles and subtract them
@fe.kernel
def sub_relu_kernel(
    ...
    with pl.section_vector():
        ...
        plm.sub_relu(tile_c, tile_a, tile_b)
...
def test_sub_relu():
    ...
    compiled_lib = fe.compile(sub_relu_kernel, arch="dav-c220-vec")
