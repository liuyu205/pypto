...
"""Frontend runtime validation for plm.printf with %x on UINT and local INDEX smoke test."""
...
def _run_add_case(compiled_lib, value_u8, value_u16, value_u32, value_u64):
    device = "npu:0"
    ...
    fe.launch(None, 1, compiled_lib, x, y, z, value_u8, value_u16, value_u32, value_u64)
...
def test_printf_x():
    ...
    _run_add_case(compiled_lib, 3, 123, 12345, 123456789)
