...
correct pto.alloc_tile / pto.tload / pto.tmul / pto.tadd patterns.
"""
...
# Kernel: load three tiles, multiply lhs with out and add rhs
@fe.kernel
def fused_mul_add_kernel(
    ...
    with pl.section_vector():
        ...
        plm.fused_mul_add(tile_c, tile_a, tile_b)
...
def test_fused_mul_add():
    ...
    compiled_lib = fe.compile(fused_mul_add_kernel, arch="dav-c220-vec")
