...
# Kernel: load three tiles, multiply two and add to accumulator
@fe.kernel
def mul_add_dst_kernel(
    ...
    with pl.section_vector():
        ...
        plm.mul_add_dst(tile_c, tile_a, tile_b)
...
def test_mul_add_dst():
    ...
    compiled_lib = fe.compile(mul_add_dst_kernel, arch="dav-c220-vec")
